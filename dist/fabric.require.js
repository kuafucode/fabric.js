    ...
    fabric.StaticCanvas = fabric.util.createClass({
        ...
        _renderBackground: function(ctx) {
            ...
            if (this.floodFillColor) {
                ...
                ctx.fillStyle = this.floodFillColor.toLive ? this.floodFillColor.toLive(ctx) : this.floodFillColor;
                ctx.fillRect(this.floodFillColor.offsetX || 0, this.floodFillColor.offsetY || 0, this.width, this.height);
                ctx.restore();
            }
        ...
        _renderOverlay: function(ctx) {
            if (this.overlayMask) {
                if (this.backgroundColor) {
                    ...
                    ctx1.fillStyle = this.backgroundColor.toLive ? this.backgroundColor.toLive(ctx1) : this.backgroundColor;
                    ctx1.fillRect(this.backgroundColor.offsetX || 0, this.backgroundColor.offsetY || 0, this.width, this.height);
                    var v = this.viewportTransform;
